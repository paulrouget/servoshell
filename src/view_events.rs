...
pub enum ViewEvent {
    ...
    /// The position of the view has changed.
    Moved(i32, i32),

    /// The view has been closed.
    Closed,

    /// A file has been dropped into the view.
    DroppedFile(PathBuf),

    /// The view received a unicode character.
    ...
    /// The cursor has moved on the view.
    ///
    /// The parameter are the (x,y) coords in pixels relative to the top-left corner of the view.
    MouseMoved(i32, i32),

    /// The cursor has entered the view.
    MouseEntered,
...
///
/// Touch may be cancelled if for example view lost focus.
pub struct Touch {
